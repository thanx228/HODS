<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProductivityReportPopup.aspx.vb" Inherits="MIS_HTI.ProductivityReportPopup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Detail Operation Report</title>
</head>
            ...
            <tr>
                <td align="left" 
                    ...
                    <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="Blue" 
                        Text="Detail Operation Report"></asp:Label>
                </td>
            </tr>
        </table>
