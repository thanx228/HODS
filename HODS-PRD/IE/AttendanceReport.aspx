<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="AttendanceReport.aspx.vb" Inherits="MIS_HTI.AttendanceReport" %>
                ...
                <tr>
                    <td style="background-image: url('../Images/btt.jpg'); background-repeat: no-repeat" 
                        ...
                        <asp:Label ID="Label5" runat="server" Font-Size="Medium" ForeColor="Blue" 
                            Text="Attendance Report" Height="22px" Width="403px"></asp:Label>
                    </td>
                </tr>
            </table>
            <table style="width: 100%;">
                <tr>
                    <td class="style12" style="background-color: #FFFFFF; vertical-align: top;">
                ...
                <tr>
                    ...
                    <td style="background-color: #FFFFFF">
                        <asp:TextBox ID="tbDateFrom" runat="server" Width="80px" placeholder="555"></asp:TextBox>
