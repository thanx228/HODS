<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserInfoPopDaily.aspx.vb" Inherits="MIS_HTI.UserInfoPopDaily" %>
                    ...
                    <tr>
                        <td style="background-image: url('../Images/btt.jpg'); background-repeat: no-repeat">
                            <asp:Label ID="Label7" runat="server" Font-Size="1.1em" ForeColor="Blue" 
                                Text="User And Work Center For Production Dairy "></asp:Label>
                        </td>
                    </tr>
                </table>
                <table style="width: 50%;">
