Public Class AssetWorkloadAdmin
    ...
    Protected Sub btCal_Click(sender As Object, e As EventArgs) Handles btCal.Click
        ...
        'If ucDate.dateVal <> "" And ymNow >= ymSel Then
        'delete ASTTR,ASTTQ
        ...
        'SQL = " select MB001,MB016,MB053,MB052-MB053 MB0523  from ASTMB " & _
        '      " where MB052-MB053>0 and MB016 <='" & ymSel & dayInMonth & "' and MB024='3'; "
