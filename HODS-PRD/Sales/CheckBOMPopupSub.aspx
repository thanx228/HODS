<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CheckBOMPopupSub.aspx.vb" Inherits="MIS_HTI.CheckBOMPopupSub" %>
        ...
        <table style="width:100%;">
            <tr>
                <td align="left" 
                    ...
                    <asp:Label ID="lbHead" runat="server" Font-Size="Medium" ForeColor="Blue"></asp:Label>
                </td>
            </tr>
        </table>
        <table style="width:100%;">
            <tr>
                ...
                <td align="center" 
                    style="background-color: #FFFFFF; border: thin solid #00CCFF">
                    <asp:Label ID="Label11" runat="server" Text="SO"></asp:Label>
                </td>
                <td align="center" 
                    style="background-color: #FFFFFF; border: thin solid #00CCFF">
