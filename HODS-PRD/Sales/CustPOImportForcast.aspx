<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="CustPOImportForcast.aspx.vb" Inherits="MIS_HTI.CustPOImportForcast" %>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        &nbsp;<asp:Label ID="Label8" runat="server" 
                            Text="Excel Format: Spec(A),PO Qty(B)" ForeColor="Blue"></asp:Label>
                    </td>
                </tr>
            </table>
