<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SaleUndeliveryStatusPopup.aspx.vb" Inherits="MIS_HTI.SaleUndeliveryStatusPopup" %>
    ...
    <div>
        ...
        <table style="width: 94%;">
            <tr>
                <td align="center" 
                    ...
                    <asp:Label ID="Label1" runat="server" Text="JP Part"></asp:Label>
                </td>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="Label2" runat="server" Text="JP SPEC"></asp:Label>
                </td>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="Label5" runat="server" Text="Undelivery Qty"></asp:Label>
                </td>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                ...
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="Label6" runat="server" Text="PR Qty"></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td align="right" style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="lbPO" runat="server" Font-Size="Medium" ForeColor="Blue"></asp:Label>
                </td>
                <td align="right" style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="lbPR" runat="server" Font-Size="Medium" ForeColor="Blue"></asp:Label>
                </td>
            </tr>
        </table>
        <table>
        ...
        <table>
            <tr>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="Label21" runat="server" Text="จำนวนรายการ PO"></asp:Label>
                </td>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="lbCountPO" runat="server" Font-Size="Medium" ForeColor="Blue"></asp:Label>
                </td>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
        ...
        <table>
            <tr>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="Label23" runat="server" Text="จำนวนรายการ PR"></asp:Label>
                </td>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="lbCountPR" runat="server" Font-Size="Medium" ForeColor="Blue"></asp:Label>
                </td>
                <td align="center" 
                    style="border: thin solid #00CCFF; background-color: #FFFFFF">
                    <asp:Label ID="Label24" runat="server" Text="รายการ"></asp:Label>
                </td>
            </tr>
        </table>
