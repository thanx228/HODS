<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="SaleUndeliveryStatusAmount.aspx.vb" Inherits="MIS_HTI.SaleUndeliveryStatusAmount" %>
                ...
                <tr>
                    <td align="left" 
                        ...
                        <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="Blue" 
                            Text="Sale Undelivery Status  With Amount"></asp:Label>
                    </td>
                </tr>
            </table>
            <table>
