<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="EditTransferOrder.aspx.vb" Inherits="MIS_HTI.EditTransferOrder" %>
        ...
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <td style="background-color: #FFFFFF">
                        <asp:SqlDataSource ID="DataSourceType" runat="server" 
                            ...
                            SelectCommand="select distinct TC001 from SFCTC where TC001 in('D201','D203','D204','D205','D206','D209') order by TC001">
                        </asp:SqlDataSource>
                    </td>
                </tr>
            </table>
            ...
            <table class="style4" style="background-color: #FFFFFF; width: 804px;">
                ...
                <tr>
                    ...
                    <td class="style8">
                        <asp:Label ID="Lprc" runat="server" ForeColor="Blue"></asp:Label>
                    </td>
                    <td class="style15">
                        <asp:TextBox ID="txtprice" runat="server" BorderStyle="Solid" Enabled="False" 
