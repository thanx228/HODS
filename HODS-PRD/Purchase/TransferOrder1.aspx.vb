...
Public Class TransferOrder1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        CrystalReportSource1.Report.FileName = Server.MapPath("~/App_Code/Print/PurchaseOutsource.rpt")
        ConfigCrystalReport.Sub_CRCrystalLogon(CrystalReportSource1.ReportDocument)
        With CrystalReportSource1.ReportDocument
            .SetParameterValue("OSNo", Request("OSNo"))
        End With
