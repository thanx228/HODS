<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="MaterialsListPrice.aspx.vb" Inherits="MIS_HTI.MaterialsListPrice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    <td align="left" 
                        ...
                        <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="Blue" 
                            Text="Materials List Price"></asp:Label>
                    </td>
                </tr>
            </table>
            <table class="style13" >
            ...
            <table style="width: 72%; margin-right: 0px; margin-bottom: 0px;">
                <tr>
                    <td align="center" 
                        style="background-image: url('../Images/btt.jpg'); background-repeat: no-repeat">
