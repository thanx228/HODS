<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="MatIssueLable.aspx.vb" Inherits="MIS_HTI.MatIssueLable" %>
            ...
            <table style="width:75%;">
                <tr>
                    <td bgcolor="White" class="style7">
                        <asp:Label ID="Label3" runat="server" Text="Issue Type"></asp:Label>
                    </td>
                    <td bgcolor="White" class="style6">
                        <uc2:docTypeD ID="ucIssueType" runat="server" />
                    </td>
                    <td bgcolor="White">
                ...
                <tr>
                    ...
                    <td bgcolor="White" class="style6">
                        <uc3:Date ID="ucIssueDate" runat="server" />
                    </td>
                    <td bgcolor="White">
