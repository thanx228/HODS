<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="ListAssetReceipt.aspx.vb" Inherits="MIS_HTI.ListAssetReceipt" %>
                ...
                <tr>
                    <td style="background-image: url('../Images/btt.jpg'); background-repeat: no-repeat">
                        <asp:Label ID="Label3" runat="server" Font-Size="1.1em" ForeColor="Blue" 
                            Text="List Asset Receipt"></asp:Label>
                    </td>
                </tr>
            </table>
            <table style="width:75%;">
                <tr>
                    <td class="style7" style="background-color: #FFFFFF; vertical-align: top;">
                        <asp:Label ID="Label9" runat="server" Text="Asset PO Type"></asp:Label>
                    </td>
