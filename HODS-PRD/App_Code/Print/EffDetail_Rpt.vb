...
Public Class EffDetail_Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.EffDetail_Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEffDetail_Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EffDetail_Rpt = New EffDetail_Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
