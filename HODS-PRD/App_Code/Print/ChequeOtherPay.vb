...
Public Class ChequeOtherPay
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.ChequeOtherPay.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PayNo() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PayType() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedChequeOtherPay
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChequeOtherPay = New ChequeOtherPay()
        rpt.Site = Me.Site
        Return rpt
    End Function
