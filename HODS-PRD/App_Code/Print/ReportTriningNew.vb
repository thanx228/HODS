...
Public Class ReportTriningNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.ReportTriningNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportTriningNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportTriningNew = New ReportTriningNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
