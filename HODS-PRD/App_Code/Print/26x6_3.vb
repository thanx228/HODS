...
Public Class Crystal_Report126x6_3
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NoCreate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystal_Report126x6_3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_Report126x6_3 = New Crystal_Report126x6_3()
        rpt.Site = Me.Site
        Return rpt
    End Function
