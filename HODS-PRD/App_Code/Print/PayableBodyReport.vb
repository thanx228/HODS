...
Public Class PayableBodyReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.PayableBodyReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tempTableB() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPayableBodyReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayableBodyReport = New PayableBodyReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
