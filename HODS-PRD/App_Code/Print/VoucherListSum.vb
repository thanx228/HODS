...
Public Class VoucherListSum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.VoucherListSum.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Type2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedVoucherListSum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VoucherListSum = New VoucherListSum()
        rpt.Site = Me.Site
        Return rpt
    End Function
