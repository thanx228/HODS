...
Public Class PurchaseOutsource
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.PurchaseOutsource.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_OSNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPurchaseOutsource
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseOutsource = New PurchaseOutsource()
        rpt.Site = Me.Site
        Return rpt
    End Function
