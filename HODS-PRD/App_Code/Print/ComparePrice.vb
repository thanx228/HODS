...
Public Class ComparePrice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.ComparePrice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tableMOQ() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ComparePriceSubrpt_tableMOQ() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedComparePrice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComparePrice = New ComparePrice()
        rpt.Site = Me.Site
        Return rpt
    End Function
