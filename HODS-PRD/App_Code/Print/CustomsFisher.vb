...
Public Class CustomsFisher
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.CustomsFisher.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tableName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCustomsFisher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustomsFisher = New CustomsFisher()
        rpt.Site = Me.Site
        Return rpt
    End Function
