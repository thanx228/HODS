...
Public Class PayableHeadReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.PayableHeadReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayableHeadReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayableHeadReport = New PayableHeadReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
