...
Public Class ReportTrining
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.ReportTrining.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportTrining
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportTrining = New ReportTrining()
        rpt.Site = Me.Site
        Return rpt
    End Function
