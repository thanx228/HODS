...
Public Class SaleOrderNotMO_Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.SaleOrderNotMO_Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleOrderNotMO_Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleOrderNotMO_Rpt = New SaleOrderNotMO_Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
