...
Public Class LotControlSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.LotControlSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLotControlSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LotControlSheet = New LotControlSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
