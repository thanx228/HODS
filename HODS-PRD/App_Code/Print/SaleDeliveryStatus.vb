...
Public Class SaleDeliveryStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.SaleDeliveryStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleDeliveryStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleDeliveryStatus = New SaleDeliveryStatus()
        rpt.Site = Me.Site
        Return rpt
    End Function
