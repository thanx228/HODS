...
Public Class BillingReceiptsOld
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS.BillingReceiptsOld.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBillingReceiptsOld
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillingReceiptsOld = New BillingReceiptsOld()
        rpt.Site = Me.Site
        Return rpt
    End Function
