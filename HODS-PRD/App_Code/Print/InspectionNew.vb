...
Public Class InspectionNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.InspectionNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInspectionNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InspectionNew = New InspectionNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
