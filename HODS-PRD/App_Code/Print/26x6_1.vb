...
Public Class Crystal_Report126x6_1
...
Public Class CachedCrystal_Report126x6_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_Report126x6_1 = New Crystal_Report126x6_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
