...
Public Class ComparePriceSub
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.ComparePriceSub.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComparePriceSub
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComparePriceSub = New ComparePriceSub()
        rpt.Site = Me.Site
        Return rpt
    End Function
