...
Public Class qcInspecReject
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.qcInspecReject.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedqcInspecReject
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As qcInspecReject = New qcInspecReject()
        rpt.Site = Me.Site
        Return rpt
    End Function
