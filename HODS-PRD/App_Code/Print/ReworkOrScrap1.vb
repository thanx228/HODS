...
Public Class ReworkOrScrap
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.ReworkOrScrap.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReworkOrScrap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReworkOrScrap = New ReworkOrScrap()
        rpt.Site = Me.Site
        Return rpt
    End Function
