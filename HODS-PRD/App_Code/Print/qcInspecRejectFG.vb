...
Public Class qcInspecRejectFG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MIS_HTI.qcInspecRejectFG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedqcInspecRejectFG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As qcInspecRejectFG = New qcInspecRejectFG()
        rpt.Site = Me.Site
        Return rpt
    End Function
