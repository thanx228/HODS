<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="MachineTable.aspx.vb" Inherits="MIS_HTI.MachineTable" %>
...
&nbsp;<asp:Label ID="LBIlde4" runat="server" BackColor="Red" BorderColor="Black" BorderWidth="1px" Text="Break" Width="70px"></asp:Label>
            ...
            <table style="width:75%;" border="1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="MachineD02" runat="server" Font-Size="Smaller" Height="30px" Text="160T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineD03" runat="server" Font-Size="Smaller" Height="30px" Text="160T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:Button ID="MachineD06" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineD07" runat="server" Font-Size="Smaller" Height="30px" Text="80T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineD08" runat="server" Font-Size="Smaller" Height="30px" Text="80T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineD09" runat="server" Font-Size="Smaller" Height="30px" Text="80T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineD10" runat="server" Font-Size="Smaller" Height="30px" Text="80T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineD11" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        &nbsp;</td>
                    <td>
                ...
                <tr>
                    <td>E</td>
                    <td>
                        <asp:Button ID="MachineE01" runat="server" Font-Size="Smaller" Height="30px" Text="160T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE02" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE03" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE04" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE05" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE06" runat="server" Font-Size="Smaller" Height="30px" Text="80T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE07" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE08" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE09" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE10" runat="server" Font-Size="Smaller" Height="30px" Text="80T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineE11" runat="server" Font-Size="Smaller" Height="30px" Text="80T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        &nbsp;</td>
                    <td>
                ...
                <tr>
                    <td>F</td>
                    <td>
                        <asp:Button ID="MachineF01" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF02" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF03" runat="server" Font-Size="Smaller" Height="30px" Text="80T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF04" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF05" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF06" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF07" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF08" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF09" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF10" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF11" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF12" runat="server" Font-Size="Smaller" Height="30px" Text="110T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineF13" runat="server" Font-Size="Smaller" Height="30px" onclick="MachineSelect" Text="110T " Width="60px" />
                    </td>
                </tr>
                <tr>
                    <td>G</td>
                    <td>
                        <asp:Button ID="MachineG01" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG02" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG03" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG04" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG05" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG06" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG07" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG08" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG09" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG10" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG11" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG12" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineG13" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                </tr>
                <tr>
                    <td>H</td>
                    <td>
                        <asp:Button ID="MachineH01" runat="server" Font-Size="Smaller" Height="30px" Text="45T" Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH02" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH03" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH04" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH05" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH06" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH07" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH08" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH09" runat="server" Font-Size="Smaller" Height="30px" Text="45T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH10" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH11" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        <asp:Button ID="MachineH12" runat="server" Font-Size="Smaller" Height="30px" Text="60T " Width="60px" onclick="MachineSelect" />
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
...
<asp:ModalPopupExtender ID="modEx1" runat="server" TargetControlID="BtnTemp1"  PopupControlID="Panel2"
    ...
    <asp:Panel ID="Panel1" runat="server" BorderWidth="1" BorderColor="Black" BackColor="White" >
        <table>
            ...
            <tr>
                <td>WO-Step:</td><td>
                <asp:Label ID="LBMONO" runat="server"></asp:Label><asp:DropDownList ID="DDLCommonMO" runat="server" ></asp:DropDownList>
