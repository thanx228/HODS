<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="checkCodeStatusPopup.aspx.vb" Inherits="MIS_HTI.checkCodeStatusPopup" %>
            ...
            <tr>
                <td align="center" 
                    ...
                    <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="Blue" 
                        Text="Detail Check Code Status"></asp:Label>
                </td>
            </tr>
        </table>
        <table style="width:100%;">
            <tr>
                ...
                <td align="center" 
                    style="background-color: #FFFFFF; border: thin solid #00CCFF">
                    <asp:Label ID="Label28" runat="server" Text="Support"></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td align="right" style="background-color: #FFFFFF; border: thin solid #00CCFF">
                    <asp:Label ID="lbDel" runat="server"></asp:Label>
                </td>
                <td align="right" style="background-color: #FFFFFF; border: thin solid #00CCFF">
                ...
                <td align="right" style="background-color: #FFFFFF; border: thin solid #00CCFF">
                    <asp:Label ID="lbPR" runat="server"></asp:Label>
                </td>
                <td align="right" style="background-color: #FFFFFF; border: thin solid #00CCFF">
                    <asp:Label ID="lbSupport" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
