...
Public Class MachinePlanByMO
    ...
    Sub SearchButton()
        Dim SqlMO As String = ""
        If TBSpec.Text <> "" Then
            SqlMO = "select SFC.TA001, SFC.TA002,MB001,MB002,MB003 " &
        "From SFCTA SFC Left Join MOCTA MOC on MOC.TA001=SFC.TA001 And MOC.TA002=SFC.TA002 Left Join INVMB on MOC.TA006=MB001 where MOC.TA013 ='Y' and MOC.TA011<>'Y' and MOC.TA011<>'y'" &
        "And MB003 like '%" & TBSpec.Text & "%' " &
        "Group by SFC.TA001, SFC.TA002,MB001,MB002,MB003 " &
        "order by SFC.TA001, SFC.TA002"
        Else
            If Date1.Text <> "" And DDLWorkCenter.SelectedValue <> "0" Then
                SqlMO = "select SFC.TA001, SFC.TA002,MB001,MB002,MB003 " &
        "From SFCTA SFC Left Join MOCTA MOC on MOC.TA001=SFC.TA001 And MOC.TA002=SFC.TA002 Left Join INVMB on MOC.TA006=MB001 " &
        " left join HOOTHAI_REPORT.dbo.PlanSchedule PlanSchedule on MoType=SFC.TA001 and MoNo=SFC.TA002 " &
        "where MOC.TA013 ='Y' and MOC.TA011<>'Y' and MOC.TA011<>'y'" &
        " and PlanSchedule.PlanDate='" & Date1.Text & "' and PlanSchedule.WorkCenter='" & DDLWorkCenter.SelectedValue & "' " &
        "Group by SFC.TA001, SFC.TA002,MB001,MB002,MB003 " &
        "order by SFC.TA001, SFC.TA002"
            Else
                show_message.ShowMessage(Page, "please input the Spec or Date", UpdatePanel1)
                Exit Sub
            End If
        End If
        ...
        For i = 0 To dtMO.Rows.Count - 1
            ...
            For L_count = 0 To dtProcess.Rows.Count - 1
                ...
                Dim SqlPlanSchedule As String = "select * from PlanSchedule where MoType='" & MOType &
                    "' and MoNo='" & MONo & "' and MoSeq='" & dtProcess.Rows(L_count).Item("TA003") & "' and PlanDate >=getdate()-1"
