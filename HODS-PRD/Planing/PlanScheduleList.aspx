<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="PlanScheduleList.aspx.vb" Inherits="MIS_HTI.PlanScheduleList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <table style="width: 75%;">
                <tr>
                    <td align="center" 
                        ...
                        &nbsp;<asp:Button ID="BtPlanExcel" runat="server" Text="Plan" />
                        &nbsp;<asp:Button ID="BtPlanOTExcel" runat="server" Text="Plan OT" />
                    </td>
                </tr>
            </table>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="BtPlanExcel" />
            <asp:PostBackTrigger ControlID="BtPlanOTExcel" />            
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
