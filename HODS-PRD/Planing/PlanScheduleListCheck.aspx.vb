    ...
    Private Sub CreateHeadGeridShow()
        ...
        If gvShow.Rows.Count > 0 Then
            ...
            While i < gvShow.HeaderRow.Cells.Count
                ...
                Dim WCName As String = String.Empty
                    ...
                    If row.RowType = DataControlRowType.DataRow Then
                        With row
                            ...
                            With .Cells(i)
                                ...
                                sendPara &= "&wcName=" & outCont.EncodeTo64UTF8(WCName)
                                'sendPara &= "&mach=" & outCont.EncodeTo64UTF8(mach)
                                ...
                                .Attributes.Add("onclick", "NewWindow('PlanScheduleCheck.aspx?" & sendPara & "','PlanScheduleMach',1000,750,'yes')")
                            End With
                        End With
                    End If
                Next
