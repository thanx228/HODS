...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Styles/MIS.Master" CodeBehind="MachinePlanByMO.aspx.vb" Inherits="MIS_HTI.MachinePlanByMO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            Date:<uc1:Date ID="Date1" runat="server" /><asp:DropDownList ID="DDLWorkCenter" runat="server" >
                        </asp:DropDownList>
            <br />
            <br />
